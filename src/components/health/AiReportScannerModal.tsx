          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-bold text-stone-900 text-base">AI Diagnostic Lab Report Scanner</h3>
                  ...
                  <div className="flex flex-col items-center justify-center space-y-2">
                    ...
                    {selectedFile ? (
                      <div>
                        ...
                        <div className="text-[10px] text-emerald-700 font-semibold mt-0.5">Ready for AI Optical Analysis</div>
                      </div>
                    ) : (
                      <div>
              ...
              <div className="bg-stone-50 rounded-2xl p-4 border border-purple-200 space-y-4 animate-in fade-in duration-200">
                ...
                {extractedData.keyFindings && extractedData.keyFindings.length > 0 && (
                  <div className="p-3 bg-purple-50/80 rounded-xl border border-purple-200 space-y-1">
                    <div className="font-bold text-purple-950 text-xs">AI Clinical Observations:</div>
